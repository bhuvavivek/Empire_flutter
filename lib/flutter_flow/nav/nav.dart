      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Profile_Screen')
        ...
        FFRoute(
          ...
          path: '/cityScreen',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'City_Screen')
              : const CityScreenWidget(),
        ),
        FFRoute(
          name: 'Area_Screen',
          path: '/areaScreen',
          builder: (context, params) => AreaScreenWidget(
        ...
        FFRoute(
          ...
          path: '/propertyScreen',
          builder: (context, params) => PropertyScreenWidget(
        ...
        FFRoute(
          ...
          path: '/homeScreen',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Home_Screen')
              : const HomeScreenWidget(),
        ),
        FFRoute(
          name: 'Property_Details_New',
          path: '/propertyDetailsNew',
          builder: (context, params) => PropertyDetailsNewWidget(
